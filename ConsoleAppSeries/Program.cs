    ...
    class Program
    {
		...
		private static void ListarSeries()
		{
			...
			foreach (var serie in lista)
			{
				...
				Console.WriteLine("Código: {0} - Título: {1} - Tipo: {2}", serie.retornaId(), serie.retornaTitulo(), (excluido ? "*Inativo*" : "Ativo"));
			}
		}
		...
		private static void InserirSerie()
		{
			...
			Util.SalvarDadosTXT(novaSerie);
		}   

		private static string ObterOpcaoUsuario()
		{
			Console.WriteLine();
			Console.WriteLine("Cadastro de séries em .NET");
